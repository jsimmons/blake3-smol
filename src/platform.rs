...
impl Platform {
    ...
    pub fn compress_in_place(
        ...
        match self {
            ...
            Platform::SSE2 => unsafe {
                crate::sse2::ffi::blake3_compress_in_place_sse2(
                    cv.as_mut_ptr(),
                    block.as_ptr(),
                    block_len,
                    counter,
            ...
            Platform::SSE41 | Platform::AVX2 => unsafe {
                crate::sse41::ffi::blake3_compress_in_place_sse41(
                    cv.as_mut_ptr(),
                    block.as_ptr(),
                    block_len,
                    counter,
            ...
            Platform::AVX512 => unsafe {
                crate::avx512::ffi::blake3_compress_in_place_avx512(
                    cv.as_mut_ptr(),
                    block.as_ptr(),
                    block_len,
                    counter,
    ...
    pub fn compress_xof(
        ...
        match self {
            ...
            Platform::SSE2 => unsafe {
                let mut out = [0u8; 64];
                crate::sse2::ffi::blake3_compress_xof_sse2(
                    cv.as_ptr(),
                    block.as_ptr(),
                    block_len,
                    counter,
            ...
            Platform::SSE41 | Platform::AVX2 => unsafe {
                let mut out = [0u8; 64];
                crate::sse41::ffi::blake3_compress_xof_sse41(
                    cv.as_ptr(),
                    block.as_ptr(),
                    block_len,
                    counter,
            ...
            Platform::AVX512 => unsafe {
                let mut out = [0u8; 64];
                crate::avx512::ffi::blake3_compress_xof_avx512(
                    cv.as_ptr(),
                    block.as_ptr(),
                    block_len,
                    counter,
    ...
    pub fn hash_many<const N: usize>(
        ...
        match self {
            ...
            Platform::SSE2 => unsafe {
                ...
                crate::sse2::ffi::blake3_hash_many_sse2(
            ...
            Platform::SSE41 => unsafe {
                ...
                // function, assert the bounds here.
                assert!(out.len() >= inputs.len() * OUT_LEN);
                crate::sse41::ffi::blake3_hash_many_sse41(
                    inputs.as_ptr() as *const *const u8,
                    inputs.len(),
                    N / BLOCK_LEN,
                    key.as_ptr(),
            ...
            Platform::AVX2 => unsafe {
                ...
                // function, assert the bounds here.
                assert!(out.len() >= inputs.len() * OUT_LEN);
                crate::avx2::ffi::blake3_hash_many_avx2(
                    inputs.as_ptr() as *const *const u8,
                    inputs.len(),
                    N / BLOCK_LEN,
                    key.as_ptr(),
            ...
            Platform::AVX512 => unsafe {
                ...
                // function, assert the bounds here.
                assert!(out.len() >= inputs.len() * OUT_LEN);
                crate::avx512::ffi::blake3_hash_many_avx512(
                    inputs.as_ptr() as *const *const u8,
                    inputs.len(),
                    N / BLOCK_LEN,
                    key.as_ptr(),
